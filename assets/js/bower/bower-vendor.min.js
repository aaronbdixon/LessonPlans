...
!function(n,r,t){var a=r.module("hmTouchEvents",[]),e=["hmHold:hold","hmTap:tap","hmDoubletap:doubletap","hmDrag:drag","hmDragstart:dragstart","hmDragend:dragend","hmDragup:dragup","hmDragdown:dragdown","hmDragleft:dragleft","hmDragright:dragright","hmSwipe:swipe","hmSwipeup:swipeup","hmSwipedown:swipedown","hmSwipeleft:swipeleft","hmSwiperight:swiperight","hmTransform:transform","hmTransformstart:transformstart","hmTransformend:transformend","hmRotate:rotate","hmPinch:pinch","hmPinchin:pinchin","hmPinchout:pinchout","hmTouch:touch","hmRelease:release"];r.forEach(e,function(n){var r=n.split(":"),e=r[0],i=r[1];a.directive(e,["$parse","$window",function(n,r){return{restrict:"A, C",link:function(a,h,o){var m,d=n(o[e]),p=function(n){a.$apply(function(){d(a,{$event:n})})},s=n(o.hmOptions)(a,{});return"undefined"!=typeof t&&r.addEventListener?((m=h.data("hammer"))||(m=t(h[0],s),h.data("hammer",m)),m.on(i,p),void a.$on("$destroy",function(){m.off(i,p)})):("hmTap"===e&&h.bind("click",p),void("hmDoubletap"===e&&h.bind("dblclick",p)))}}}])})}(window,window.angular,window.Hammer);
